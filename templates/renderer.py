...
instInfo = [
	{'type' : 'MOV', 'formBin' : 'R', 'formAsm' : ['IRD', 'IRS'], 'code' : ["%(arg0)s = %(arg1)s"]},
	...
	{'type' : 'NOT', 'formBin' : 'R', 'formAsm' : ['IRD', 'IRS'], 'code' : ["%(arg0)s = ~%(arg1)s"]},
	...
	{'type' : 'ITOF', 'formBin' : 'R', 'formAsm' : ['FRD', 'IRS'], 'code' : ["tmp1.f = (float)%(arg1)s", "%(arg0)s = tmp1.i"]},
	{'type' : 'IMOVF', 'formBin' : 'R', 'formAsm' : ['FRD', 'IRS'], 'code' : ["memcpy(&%(arg0)s, &%(arg1)s, 4)"]},
	{'type' : 'FTOI', 'formBin' : 'R', 'formAsm' : ['IRD', 'FRS'], 'code' : ["tmp1.i = %(arg1)s", "%(arg0)s = (int32_t)tmp1.f"]},
	{'type' : 'FMOVI', 'formBin' : 'R', 'formAsm' : ['IRD', 'FRS'], 'code' : ["memcpy(&%(arg0)s, &%(arg1)s, 4)"]},
	...
	{'type' : 'INPUTBYTE', 'formBin' : 'R', 'formAsm' : ['IRD'], 'code' : ["%(arg0)s = getchar() & 0xff"]},
	{'type' : 'INPUTWORD', 'formBin' : 'R', 'formAsm' : ['IRD'], 'code' : ["%(arg0)s = (getchar() & 0xff) << 24", "%(arg0)s |=(getchar() & 0xff) << 16", "%(arg0)s |= (getchar() & 0xff) << 8", "%(arg0)s |= (getchar() & 0xff)"]},
	{'type' : 'INPUTFLOAT', 'formBin' : 'R', 'formAsm' : ['FRD'], 'code' : ["%(arg0)s = (getchar() & 0xff) << 24", "%(arg0)s |=(getchar() & 0xff) << 16", "%(arg0)s |= (getchar() & 0xff) << 8", "%(arg0)s |= (getchar() & 0xff)"]},
